...
function Is!(sourcevec,u,t,par)
    ...
    sourcevec[1] = 0.0
    sourcevec[2] = 0.0
    sourcevec[3] = (-(γ^2    -1//4)*x1/λ         + 2γ*v*x2/κ/T      - μ*v^2*x3/η)/μ^5;
    sourcevec[4] = (-(γ^2*v  + 0  )*x1/λ         + γ*(v^2+1)*x2/κ/T - μ*v*x3/η)/μ^5;
    sourcevec[5] = (-(γ^2*v^2+1//4)*x1/λ         + 2γ*v*x2/κ/T      - μ*x3/η)/μ^5;
    sourcevec[6] = 0.0
    sourcevec[7] = 0.0
    sourcevec[8] = 0.0
    sourcevec[9] = 0.0
