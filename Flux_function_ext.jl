...
function Flux_imp!(Fl,u,p)
    ...
    T11_2 = χ₂*(T^12*ν^2*(-832//3 + 304//3*γ^2 - 32//3*γ^4 - 1296*γ^2*v^2 + 1664//3*γ^4*v^2 - 256//3*γ^6*v^2*(v^2-1)^2 - 544*γ^4*v^4) + T^11*r1*v*ν*γ*(-1120) + T^10*(r1^2*(-288+36*γ^2-648*γ^2*v^2+96*v^2*(1+γ^4*(1+v^4))+612*γ^2*v^4-192*γ^4*v^4) - 112*t11*ν) + T^9*(-336)*r1*t11*v*γ*(1-v^2) + T^8*t11^2*(-33 + v^2*(42-9*v^2) + γ^2*v^2*(-72*(1+v^4)+144*v^2)))
